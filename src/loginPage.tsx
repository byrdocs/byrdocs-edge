    ...
    return (
        <Layout>
            <div className="h-[100vh] flex flex-col">
                <div className="md:rounded-lg border bg-card text-card-foreground shadow-sm w-full md:w-[500px] m-auto p-4">
                    <div className="flex flex-col p-6 pb-0 space-y-1">
                        <h3 className="whitespace-nowrap font-semibold tracking-tight text-2xl">登录 BYR Docs</h3>
                        <p className="text-sm text-muted-foreground pt-2">
                            由于您没有使用北邮校园网(IPv6)访问本站，所以我们需要使用
                            <a href="https://auth.bupt.edu.cn/authserver/login" target="_blank"
                                className="text-blue-500 hover:underline">北邮统一认证</a>
                            确认您的身份。
                        </p>
                ...
                <footer className="h-12 text-center text-sm flex text-gray-500">
                    <p className="m-auto">
                        您的认证信息将会被发送到<a href="https://auth.bupt.edu.cn/authserver/login" target="_blank" className="text-blue-500 hover:underline">北邮统一认证</a>，我们不会存储任何信息。
                    </p>
                </footer>
            </div>
        </Layout>
